...
class Ritmo
{
	...
	public function save_meta_box($post_id)
	{
		...
		/*
		 * If this is an auto save, form has not been submitted,
	...
	public function render_meta_box_content($post)
	{
        ...
        <p><input type="text" id="ritmo_url" name="ritmo_url" value="<?php echo esc_attr($value); ?>" style="width:100%"
                  dir="ltr"/></p>
		<?php
	}

	/**
	 * Create shortcode for show embedded in post/page or text widget
	 *
	 * @param Not param
	 * @return string|void
	 */
